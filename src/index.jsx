...
export const VitePay = ({
  ...
  async function validatePayment(hashTx, memo, amount, tokenId) {
    ...
    if (hashTx.data == encode(memo) && parseInt(amountTx) == parseInt(amount) && hashTx.tokenId == tokenId && hashTx.timestamp > (new Date().getTime()/1000 - parseInt(paymentTimeout))) valid = true;
    return valid;
  }
