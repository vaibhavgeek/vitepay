    ...
    <div className={styles.App}>
      ...
      <ReactModal className={styles.modal} isOpen={open}>
        ...
        <form className={styles.vitepay}>
          ...
          {state === 0 && (
            <TransactionForm displayAmount={displayAmount} displayMemo={displayMemo} displayToken={displayToken} address={address} setAddress={setAddress} memo={memo} setMemo={setMemo} tokenId={tokenId} setTokenId={setTokenId} amount={amount} setAmount={setAmount} options={options} />
          )}
